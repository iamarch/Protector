...
# Copyright (C) 2020 - 2021  Kunal-Diwan, <https://github.com/Kunal-Diwan.git>
#
...
from . import Protector as __bot__
...
def on(
    ...
    Parameters:
        ...
        update (`str`, *optional*):
            ...
            `command` -> `~Protector.Client.on_command`,
            `message` -> `~Protector.Client.on_message`,
            `callbackquery` -> `~Protector.Client.on_callback_query`.
    """
