...
from .errors import ProtectorException, CommandInvokeError
...
class Client(pyrogram.Client):  # pylint: disable=too-many-ancestors
    ...
    def __init__(self, bot: "Protector", **kwargs: Any) -> None:
        self.__bot__ = bot
    ...
    def on_command(self, filters: Optional[Filter] = None, group: int = 0) -> callable:
        ...
        def decorator(func: Callable) -> callable:
            ...
            async def wrapper(_: Client, message: Message) -> None:
                ...
                except (ProtectorException, StopPropagation, ContinuePropagation):
                    raise
